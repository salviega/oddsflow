...
import { OnlyUnansweredQuestion } from "./instructions/OnlyUnansweredQuestion.sol";

/// @title OddsFlowOpcodes
/// @notice The official Aqua opcode table, unchanged, with three instructions
///   appended at the end so every official opcode keeps its index.
contract OddsFlowOpcodes is AquaOpcodes, FixedPriceSwap, OnlyUnresolvedCondition, OnlyUnansweredQuestion {
        ...
        returns (function(Context memory, bytes calldata) internal[] memory result)
    {
        ...
        result = new function(Context memory, bytes calldata) internal[](official.length + 3);
        ...
        result[official.length + 2] = OnlyUnansweredQuestion._onlyUnansweredQuestion;
    }
}
